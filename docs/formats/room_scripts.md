...
| `0x43` (67) | `SetTileObjectDrawLayer` | 3 (x, y, layer 2-bit value) | Resolves the tile object and writes the low two bits of the operand into `Object.bGfxSlotAndFlags` bits 2-3, the draw layer (`ObjectFlagsD5.bDrawLayer`, same field `SetObjectDrawLayer` writes). Handler at US `0x0801CF64`. |
