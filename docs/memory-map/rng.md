...
| `Mt19937AutoSeed` | `0x0803B330` | `0x0803B398` | Derives a seed from boot-time/frame-counter globals (`0x0300356C`+`0x1c`, a `0x030034EC` halfword counter, an accumulating `0x03005594` global) and calls `Mt19937SetSeed`. Likely the startup auto-seed path. |
