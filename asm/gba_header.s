...
NintendoLogo: @ 0x08000004
	@ Nintendo's own bitmap, required identical on every licensed cart;
	@ also embedded by third-party tools like gbafix. Fair use for
	@ interoperability (cf. Sega v. Accolade).
